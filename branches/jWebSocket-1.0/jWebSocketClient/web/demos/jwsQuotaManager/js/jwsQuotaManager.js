	...
	Ext.create('Ext.window.Window', {
		...
		listeners: {
			afterrender: function () {
				...
				Ext.tip.QuickTipManager.register({
					target: Ext.get('namespace_diskspace'),
