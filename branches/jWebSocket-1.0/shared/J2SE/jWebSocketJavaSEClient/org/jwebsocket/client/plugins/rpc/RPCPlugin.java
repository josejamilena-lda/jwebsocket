//	---------------------------------------------------------------------------
//	jWebSocket - RPCPlugin (Community Edition, CE)
//	---------------------------------------------------------------------------
...
public class RPCPlugin {
	...
	/**
	 * Add a Method to the list of rpc granted. rrpc authorization is default:
	 * false.
	 *
	 * @param aMethod
	 */
	...
	/**
	 * Add a Method to the list of rrpc granted method. If aRrpcCallable is
	 * true, allow other client to access to this method using a rrpc. If false,
	 * only server rpc will be allowed
	 *
	 * @param aMethod
	 * @param aRrpcCallable
	 */
	...
	/**
	 * Process a rrpc call. TODO: doesn't send back any answer. Do smthg with
	 * lMsg & lResponseToken.
	 *
	 * @param aClassName
	 * @param aMethodName
