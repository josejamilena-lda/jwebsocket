//	---------------------------------------------------------------------------
//	jWebSocket - ResponseEvent (Community Edition, CE)
//	---------------------------------------------------------------------------
...
public class ResponseEvent extends Event {
	...
	/**
	 * @return The time in nanoseconds needed by the listeners to process the
	 * event
	 */
	...
	/**
	 * @param aProcessingTime The time in nanoseconds needed by the listeners to
	 * process the event
	 */
